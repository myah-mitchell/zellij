...
release on this fork, with notes generated by `git-cliff` covering the commits
since the previous tag. The artifact carries upstream's own naming so it drops

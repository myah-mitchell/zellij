...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Payload {
        ...
        GetSessionListPayload(super::GetSessionListPayload),
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetPaneFrameStylePayload {
    #[prost(enumeration="super::pane_frame_style::PaneFrameStyle", tag="1")]
    pub pane_frame_style: i32,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetSessionListPayload {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SessionListSnapshot {
    #[prost(message, repeated, tag="1")]
    pub live_sessions: ::prost::alloc::vec::Vec<super::event::SessionManifest>,
    #[prost(message, repeated, tag="2")]
    pub resurrectable_sessions: ::prost::alloc::vec::Vec<super::event::ResurrectableSession>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetSessionListResponse {
    #[prost(oneof="get_session_list_response::Result", tags="1, 2")]
    pub result: ::core::option::Option<get_session_list_response::Result>,
}
/// Nested message and enum types in `GetSessionListResponse`.
pub mod get_session_list_response {
    #[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Result {
        #[prost(message, tag="1")]
        Snapshot(super::SessionListSnapshot),
        #[prost(string, tag="2")]
        Error(::prost::alloc::string::String),
    }
}
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DeleteDeadSessionResponse {
    /// absent => success
    #[prost(string, optional, tag="1")]
    pub error: ::core::option::Option<::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DeleteAllDeadSessionsResponse {
    /// absent => success
    #[prost(string, optional, tag="1")]
    pub error: ::core::option::Option<::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetSoftKeyboardPayload {
    #[prost(bool, tag="1")]
    pub on: bool,
}
